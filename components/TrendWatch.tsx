...
export const TrendWatch: React.FC = () => {
  ...
  return (
    <section className="max-w-[1440px] mx-auto px-6 md:px-16 py-32 border-t border-black min-h-[80vh]">
      <div className="max-w-4xl mx-auto mb-16">
        <div className="text-center mb-12">
           <span className="text-[10px] font-sans font-bold tracking-[0.3em] uppercase text-accent mb-4 block">The Oracle</span>
           <h2 className="font-display text-6xl mb-8">Trend Watch</h2>
        </div>
