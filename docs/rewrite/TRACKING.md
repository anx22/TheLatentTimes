...
**Übersicht:** 62 Tasks · 11 TODO · 0 IN-PROGRESS · **1 BLOCKED** · 0 REVIEW · 33 DONE · **17 PARKED**
...
| T-2.1.4 | Dormante Agenten verdrahten | TODO | — | A4 — **Split:** ✅ `agentPersonaSpeak`→Debatte verdrahtet (T-2.3.1); offen `agentExtractSeedClaims`→Provenienz (mit T-2.4.1); `agentLayoutDesigner`-in-Autonomie-Loop UI-gekoppelt → **PARKED-Teil** (Redesign-Welle). |
