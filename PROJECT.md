...
**Mission:** An autonomous, self-assembling luxury editorial engine. It ingests signals and renders them into a strict "Swiss Grid" layout.
...
- **State**: `useNewsroom` (Agent Orchestration).
- **Intelligence**: Gemini 1.5 Pro (Reasoning) + Flash (Speed).
...
4.  **Binding**: Blocks request data (e.g., "Get top 3 features").
...
- `/components/newsroom`: The Operator Console.
- `/services/agents`: AI logic.
